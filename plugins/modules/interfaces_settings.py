...
"""interfaces_settings module: Module to configure OPNsense interface settings"""
...
def main():
    """
    Main function of the interfaces_settings module
    """
    ...
    interface_setting = InterfaceSetting.from_ansible_module_params(module.params)
